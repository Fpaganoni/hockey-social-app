...
export function StoriesCarousel() {
  const stories = Array.from({ length: 10 }, (_, i) => ({
    id: i,
    name: ["Alex J.", "Sarah M.", "HC Amsterdam", "Coach Mike", "Team Netherlands", "James P.", "Old Club de Liege", "Fiorela Tirabassi", "Tom Boom", "Club Genk"][i],
    image: `/user.png`,
  }))

  return (
    <div className="bg-dark-gray-2/85 border-b border-primary px-4 py-4 ">
      <div className="flex gap-6 overflow-x-auto p-2 scroll-smooth ">
        {stories.map((story) => (
          <button 
            key={story.id} 
